...
# from src.services.bg_vid_generation.generate_bg_video import generate_background_video_using_assets
# from src.services.video_editing.combine_videos import combine_videos
...
#         final_video_path_with_captions = add_captions_acc_to_layout(combined_video_path, caption_type="RED_WHITE",layout_type="TOP_BOTTOM")
